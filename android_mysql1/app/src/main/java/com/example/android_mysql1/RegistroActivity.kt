...
class RegistroActivity : AppCompatActivity() {
    ...
    fun cargarDatos(){
        ...
        val url = "http://192.168.43.30/android_mysql1/registro.php?id=$id"
    ...
    fun eliminar(Vista: View){
        val url = "http://192.168.43.30/android_mysql1/eliminar.php"
        procesoEnCola= Volley.newRequestQueue(this)
    ...
    fun editar(Vista: View){
        val url = "http://192.168.43.30/android_mysql1/editar.php"
        procesoEnCola = Volley.newRequestQueue(this)
